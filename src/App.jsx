...
const fetchPokemonByName = (pokemonName) => {
...
const fetchAllPokemon = (limit = 151) => {
...
const fetchFeaturedPokemon = (offset = 0, limit = 3) => {
  ...
  return (
    <BrowserRouter>
      <Routes
        ...
        fetchFeaturedPokemon={fetchFeaturedPokemon}
      />
    </BrowserRouter>
  );
}
